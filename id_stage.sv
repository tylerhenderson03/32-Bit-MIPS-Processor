...
// truncations to pass-through
    assign rd_out[4:0] = linkReg ? 5'd31 : if_out[15:11]; // instruction [20:16] shifted into EX stage
...
/* "wb_ctrl" is 2 bits:
    ...
    [1] - RegWrite // register write enable signal used during W.B. (almost always)
...
// control unit logic - combinational
    always_comb begin
        case(if_out[31:26])
            6'd0: begin // add, addu, and, jr, nor, or, slt, sltu (r)
