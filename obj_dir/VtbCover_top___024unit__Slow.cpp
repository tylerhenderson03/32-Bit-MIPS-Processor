...
VtbCover_top___024unit::VtbCover_top___024unit() = default;
VtbCover_top___024unit::~VtbCover_top___024unit() = default;

void VtbCover_top___024unit::ctor(VtbCover_top__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
    vlNamep = strdup(Verilated::catName(vlSymsp->name(), namep));
    // Reset structure values
}

void VtbCover_top___024unit___configure_coverage(VtbCover_top___024unit* vlSelf, bool first);

void VtbCover_top___024unit::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    VtbCover_top___024unit___configure_coverage(this, first);
}

void VtbCover_top___024unit::dtor() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void VtbCover_top___024unit::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void VtbCover_top___024unit::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
