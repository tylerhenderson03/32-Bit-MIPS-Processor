...
VL_ATTR_COLD void Vtb_id___024root__trace_init_sub__TOP__0(Vtb_id___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,0,"ex_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+9,0,"mem_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+10,0,"wb_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBus(c+45,0,"sgn_extend_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+6,0,"rd_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBus(c+7,0,"rt_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+8,0,"ex_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+9,0,"mem_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+10,0,"wb_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBus(c+45,0,"sgn_extend_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+7,0,"rt_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
...
VL_ATTR_COLD void Vtb_id___024root__trace_const_0_sub_0(Vtb_id___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+50,(0x0000000aU),32);
}
...
VL_ATTR_COLD void Vtb_id___024root__trace_full_0_sub_0(Vtb_id___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,((0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                            >> 0x0000000bU))),5);
    bufp->fullCData(oldp+7,((0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                            >> 0x00000010U))),5);
    bufp->fullCData(oldp+8,(vlSelfRef.tb_id__DOT__ex_ctrl),4);
    bufp->fullCData(oldp+9,(vlSelfRef.tb_id__DOT__mem_ctrl),3);
    bufp->fullCData(oldp+10,(vlSelfRef.tb_id__DOT__wb_ctrl),2);
    ...
    bufp->fullIData(oldp+43,(vlSelfRef.tb_id__DOT__id_00__DOT__i),32);
    bufp->fullBit(oldp+44,(vlSelfRef.tb_id__DOT__clk));
    bufp->fullIData(oldp+45,(vlSelfRef.tb_id__DOT__sgn_extend_out),32);
    ...
    bufp->fullIData(oldp+47,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file
                             [(0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                              >> 0x00000010U))]),32);
    bufp->fullIData(oldp+48,(vlSelfRef.tb_id__DOT__id_00__DOT__unnamedblk1__DOT__j),32);
}
