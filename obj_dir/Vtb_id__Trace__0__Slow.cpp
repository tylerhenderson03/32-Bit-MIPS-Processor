...
VL_ATTR_COLD void Vtb_id___024root__trace_init_sub__TOP__0(Vtb_id___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+43,0,"clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+3,0,"wr_reg",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+46,0,"wb_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+47,0,"mem_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+48,0,"ex_ctrl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+49,0,"pc_incr_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+9,0,"rd_data_one",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+10,0,"rd_data_two",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+3,0,"wr_reg",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+46,0,"wb_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+47,0,"mem_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+48,0,"ex_ctrl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+49,0,"pc_incr_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+9,0,"rd_data_one",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+10,0,"rd_data_two",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vtb_id___024root__trace_const_0_sub_0(Vtb_id___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+46,(vlSelfRef.tb_id__DOT__wb_ctrl));
    bufp->fullCData(oldp+47,(vlSelfRef.tb_id__DOT__mem_ctrl),3);
    bufp->fullCData(oldp+48,(vlSelfRef.tb_id__DOT__ex_ctrl),3);
    bufp->fullIData(oldp+49,(vlSelfRef.tb_id__DOT__pc_incr_out),32);
}
...
VL_ATTR_COLD void Vtb_id___024root__trace_full_0_sub_0(Vtb_id___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelfRef.tb_id__DOT__wr_reg),32);
    ...
    bufp->fullCData(oldp+8,((0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                            >> 0x00000010U))),5);
    bufp->fullIData(oldp+9,(vlSelfRef.tb_id__DOT__rd_data_one),32);
    bufp->fullIData(oldp+10,(vlSelfRef.tb_id__DOT__rd_data_two),32);
    bufp->fullIData(oldp+11,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[0]),32);
    bufp->fullIData(oldp+12,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[1]),32);
    bufp->fullIData(oldp+13,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[2]),32);
    bufp->fullIData(oldp+14,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[3]),32);
    bufp->fullIData(oldp+15,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[4]),32);
    bufp->fullIData(oldp+16,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[5]),32);
    bufp->fullIData(oldp+17,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[6]),32);
    bufp->fullIData(oldp+18,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[7]),32);
    bufp->fullIData(oldp+19,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[8]),32);
    bufp->fullIData(oldp+20,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[9]),32);
    bufp->fullIData(oldp+21,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[10]),32);
    bufp->fullIData(oldp+22,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[11]),32);
    bufp->fullIData(oldp+23,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[12]),32);
    bufp->fullIData(oldp+24,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[13]),32);
    bufp->fullIData(oldp+25,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[14]),32);
    bufp->fullIData(oldp+26,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[15]),32);
    bufp->fullIData(oldp+27,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[16]),32);
    bufp->fullIData(oldp+28,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[17]),32);
    bufp->fullIData(oldp+29,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[18]),32);
    bufp->fullIData(oldp+30,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[19]),32);
    bufp->fullIData(oldp+31,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[20]),32);
    bufp->fullIData(oldp+32,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[21]),32);
    bufp->fullIData(oldp+33,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[22]),32);
    bufp->fullIData(oldp+34,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[23]),32);
    bufp->fullIData(oldp+35,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[24]),32);
    bufp->fullIData(oldp+36,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[25]),32);
    bufp->fullIData(oldp+37,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[26]),32);
    bufp->fullIData(oldp+38,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[27]),32);
    bufp->fullIData(oldp+39,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[28]),32);
    bufp->fullIData(oldp+40,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[29]),32);
    bufp->fullIData(oldp+41,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[30]),32);
    bufp->fullIData(oldp+42,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file[31]),32);
    bufp->fullBit(oldp+43,(vlSelfRef.tb_id__DOT__clk));
}
