...
void Vtb_id___024root__trace_chg_0_sub_0(Vtb_id___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+6,((0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                               >> 0x0000000bU))),5);
        bufp->chgCData(oldp+7,((0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                               >> 0x00000010U))),5);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        bufp->chgCData(oldp+8,(vlSelfRef.tb_id__DOT__ex_ctrl),4);
        bufp->chgCData(oldp+9,(vlSelfRef.tb_id__DOT__mem_ctrl),3);
        bufp->chgCData(oldp+10,(vlSelfRef.tb_id__DOT__wb_ctrl),2);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        ...
        bufp->chgIData(oldp+43,(vlSelfRef.tb_id__DOT__id_00__DOT__i),32);
    }
    bufp->chgBit(oldp+44,(vlSelfRef.tb_id__DOT__clk));
    bufp->chgIData(oldp+45,(vlSelfRef.tb_id__DOT__sgn_extend_out),32);
    ...
    bufp->chgIData(oldp+47,(vlSelfRef.tb_id__DOT__id_00__DOT__register_file
                            [(0x0000001fU & (vlSelfRef.tb_id__DOT__if_out 
                                             >> 0x00000010U))]),32);
    bufp->chgIData(oldp+48,(vlSelfRef.tb_id__DOT__id_00__DOT__unnamedblk1__DOT__j),32);
}
